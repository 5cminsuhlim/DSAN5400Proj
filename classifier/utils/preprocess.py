...
class dfBuilder:
    ...
    def __init__(
        self,
        path="../../data/raw_data",
        stopword_path="../../data/clinical-stopwords.txt",
    ):
        self.path = path
        ...
        for dirs in self.dir_list:
            ...
            if "test" in dirs:
                ...
                df_test = df_test.rename(
                    columns={"condition_label": "label", "medical_abstract": "text"}
                )
    ...
    def train_test(self):
        ...
        logging.info(
            "The train and test set have been generated. This step did not save the train and test set to CSV."
        )
    ...
    def save_to_csv(self):
        ...
        logging.info(
            "Train and test sets saved to CSV with names: train_cleaned, test_cleaned and data_cleaned."
        )
